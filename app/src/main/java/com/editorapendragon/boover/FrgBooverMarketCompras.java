...
public class FrgBooverMarketCompras extends Fragment {
    ...
    private CustomBooksMarketComprasListAdapter adapterdetails;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        lblmyshelf.setText(getResources().getString(R.string.minhas_compras));
        ...
        if (vBook!=null) {
            ...
            mDatabase.child("Compras").child(mUid).orderByChild("mordercompra")
                    .addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            for (DataSnapshot bookDataSnapshot : dataSnapshot.getChildren()) {
                                ...
                                for (DataSnapshot transactionDataSnapshot : bookDataSnapshot.getChildren()) {
                                    ...
                                    for (DataSnapshot dadosDataSnapshot : transactionDataSnapshot.getChildren()) {
                                        ...
                                        if (dadosDataSnapshot.getKey().equals("vUid")) {
                            ...
                            adapterdetails = new CustomBooksMarketComprasListAdapter(context, vUid, vStatus,
            ...
            btnEntregues.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    FragmentTransaction ft = ((MainActivity) getContext()).getSupportFragmentManager().beginTransaction();
                    ft.replace(R.id.frgboovermarketfiltros_frame, fFrag, "FrgBooverMarketCompras");
